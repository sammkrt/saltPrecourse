namespace TrainingGround.Tests
{
    public class LinqTests
    {
        ...
        Console.WriteLine(numbersLargerThan15);
        ...
        public void filter_people_by_age_only_names()
        {
            ...
            .Select(p => p.Name)
            .ToList();
            foreach (string i in allWithLongNames)
            {
                Console.WriteLine(i);
            }
            // assert
        ...
        public void filter_people_by_age_names_age()
        {
            ...
            .ToList();
            foreach (var i in namesAndAges)
            {
                Console.WriteLine(namesAndAges[0]);
            }
